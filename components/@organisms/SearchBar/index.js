...
const SearchBar = ({ $, l, ditch, state, actions, ...props }) => {
	...
	const { t999, isOpened, openSearchBar, closeSearchBar, isInlay } = props
	...
	const searchBarClass = cx({
		...
		[$.mobileSearchBarContainer]: t999 && !isInlay,
		[$.inlayMobileSearchBarContainer]: t999 && isInlay
	})
	...
	return (
		<div className={$.container}>
			{t999 && !isInlay ? renderInfoBar() : null}
